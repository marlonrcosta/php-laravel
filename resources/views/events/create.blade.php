...
<div id="events-container" class="col-md-10 offset-md-1">
    <h4 class="mt-3">Cadastrar cliente</h4>
    <form action="/events" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" id="nascimento" name="nascimento" class="form-control" placeholder="Data nascimento">
            </div>
            <div class="col-md-3 form-group">
        ...
        <div class="row mt-4">
            ...
            <div class="col-2">
                ...
                <a href="/events/create" class="btn btn-secondary">Limpar</a>
            </div>
        </div>
    </form>
</div>
